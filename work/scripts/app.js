  ...
  app.updateForecastCard = function(data) {
    ...
    if (cardLastUpdated) {
      ...
      if (dataLastUpdated.getTime() < cardLastUpdated.getTime()) {
		    card.querySelector('.description').textContent = 'Cached';
        return;
      }
    }
  ...
  var initialWeatherForecast = {
    ...
    channel: {
      ...
      item: {
        condition: {
          text: "TORNADO ALERT",
          date: "Thu, 21 Jul 1916 09:00 PM EDT",
          temp: 560,
          code: 24
        },
        forecast: [
          {code: 44, high: 11, low: 32},
          {code: 44, high: 12, low: 43},
          {code: 4, high: 23, low: 54},
          {code: 24, high: 34, low: 65},
          {code: 24, high: 45, low: 76},
          {code: 44, high: 56, low: 87},
          {code: 44, high: 67, low: 98}
        ]
      },
      atmosphere: {
        humidity: 560
